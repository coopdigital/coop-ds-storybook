...
const Signpost = ({ title, url, mediaComponent, dataContentType, dataContentParent, dataLinkText  }) => {
  ...
  return (
    <>
      <div className={rootClasses}>
        <a
          href={url}
          className="coop-c-signpost__link"
          data-contenttype=""
          data-contentparent=""
          data-linktext=""
        >
          ...
          <div className="coop-c-signpost__content">
            <h3 className="coop-c-signpost__title">{title}</h3>
            <span className="coop-c-signpost__icon" aria-hidden="true">
              <svg className="coop-c-signpost__icon__svg" viewBox="0 0 16 29">
...
Signpost.propTypes = {
  ...
  dataContentType: PropTypes.string,
  dataContentParent: PropTypes.string,
