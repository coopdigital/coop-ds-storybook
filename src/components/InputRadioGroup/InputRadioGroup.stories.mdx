...
<Meta title="Elements/InputRadioGroup" component={InputRadioGroup} subcomponents={InputRadioGroup}/>
...
<Canvas>
  <InputRadioGroup
    id="group1" legend="Basic radio group with hint" hint="Hint message to help guide the user">
      <InputRadio id="radio-1" name="radio-1" label="Radio 1" value={1} />
      <InputRadio id="radio-2" name="radio-2" label="Radio 2" value={2} />
      <InputRadio id="radio-3" name="radio-3" label="Radio 3" value={3} />
  </InputRadioGroup>
